//! One settings folder for a family of applications.
//!
...
//! ```text
//! ~/.config/quvyta/
//!     quvyta.conf     the family's shared settings
...
/// The extension every settings file of a family carries.
...
impl Family {
    ...
    /// The lowercase name of the family's folder on Linux and other Unix systems and of its
    /// shared file.
    #[must_use]
    ...
    /// [`adopt`](Self::adopt) into `config_dir` as the family's folder instead of this
