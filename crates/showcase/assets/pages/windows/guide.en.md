...
- **Three marks.** Minimize, maximize (restore while maximized) and close sit at the right end of the title, three cells each, and light up together under the pointer like every close mark in the ecosystem. A press that is released somewhere else does nothing.
