...
- **Dar yolda orta kısım katlanır.** Yol sığmayınca kök ve sığdığı kadar son seviye kalır, arada `…` durur. `…` açılınca gizli seviyeler listelenir. Çok dar alanda yalnızca `…` ve bulunduğun yer görünür.
