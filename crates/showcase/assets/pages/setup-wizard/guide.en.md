...
- **Always the first step.** Even when the ecosystem already shares a language, a theme and icons, the step is shown, filled in from the shared file and with every box ticked, so Next alone accepts all of it.
