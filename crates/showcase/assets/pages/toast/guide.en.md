...
- **The runtime owns the stack.** Toasts are not part of your view: they outlive the screen that raised them and are drawn above every layer, dialogs included. Your application keeps no toast state.
...
- **They stack in a corner**, newest nearest the corner, with one row of space between them. Toasts that do not fit wait until others leave.
